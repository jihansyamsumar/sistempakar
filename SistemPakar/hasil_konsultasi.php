                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="<?php echo $row['usia'] ?>" name="usia" readonly>
                        </div>
                        ...
                        <?php
                            ...
                            $no=1;
                            $sql = "SELECT detail_konsultasi.idkonsultasi,detail_konsultasi.idgejala,detail_konsultasi.kdgejala,
                        ...
                        <?php
                            ...
                            $no=1;
                            $sql = "SELECT detail_penyakit.idkonsultasi,detail_penyakit.idpenyakit,detail_penyakit.kdpenyakit,
